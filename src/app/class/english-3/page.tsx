...
export default function English3Room() {
  const id = "english-3";
  const videoSrc = "/videos/english/english-3.mp4";
      ...
      <section className="max-w-6xl mx-auto px-6 py-10 grid lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7">
          <div className="border border-white/10 rounded-3xl p-5 bg-white/5">
            ...
            <div className="text-xl font-extrabold">@english.tutor03</div>
            <div className="text-white/70 text-sm mt-1">English Video 3</div>
