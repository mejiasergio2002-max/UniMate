...
export default function English1Room() {
  const id = "english-2";
  const videoSrc = "/videos/english/english-2.mp4";
          ...
          <div className="border border-white/10 rounded-3xl p-5 bg-white/5">
            ...
            <div className="mt-5 border border-white/10 rounded-2xl p-4 bg-black/20">
              ...
              <div className="mt-3 flex gap-2">
                <button onClick={() => tip(1)} className="px-4 py-2 rounded-xl bg-violet-600 font-semibold">$1</button>
                <button onClick={() => tip(3)} className="px-4 py-2 rounded-xl bg-violet-600 font-semibold">$3</button>
                <button onClick={() => tip(10)} className="px-4 py-2 rounded-xl bg-violet-600 font-semibold">$10</button>
              </div>
