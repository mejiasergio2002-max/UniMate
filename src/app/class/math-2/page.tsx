...
export default function Math2Room() {
  const id = "math-2";
  const videoSrc = "/videos/math/math-2.mp4";
      ...
      <section className="max-w-6xl mx-auto px-6 py-10 grid lg:grid-cols-12 gap-6">
        <div className="lg:col-span-7">
          <div className="border border-white/10 rounded-3xl p-5 bg-white/5">
            ...
            <div className="text-xl font-extrabold">@math.tutor02</div>
            <div className="text-white/70 text-sm mt-1">Math Video 2</div>
