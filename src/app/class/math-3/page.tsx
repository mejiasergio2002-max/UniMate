...
export default function Math3Room() {
  const id = "math-3";
  const videoSrc = "/videos/math/math-3.mp4";
      ...
      <section className="max-w-6xl mx-auto px-6 py-10 grid lg:grid-cols-12 gap-6">
        <div className="lg:col-span-7">
          <div className="border border-white/10 rounded-3xl p-5 bg-white/5">
            ...
            <div className="text-xl font-extrabold">@math.tutor03</div>
            <div className="text-white/70 text-sm mt-1">Math Video 3</div>
